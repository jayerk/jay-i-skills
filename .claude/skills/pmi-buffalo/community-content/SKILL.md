...
Chapter event content — talks, workshops, presentations, and engagement strategies for PMI Buffalo chapter events and the broader PM practitioner community.

TRIGGER when: designing a talk, workshop, or presentation for PMI Buffalo or a similar chapter event; writing an article for a PM practitioner audience; building community engagement content.
DO NOT TRIGGER when: writing internal work content or thought leadership for an employer audience (that's the work-context `community-content` skill); creating executive presentations (that's `executive-storytelling`).

## Instructions

### Quality Bar

- **Actionable** — every talk or article includes at least one tool, template, or technique the audience can apply Monday morning. "Here's a framework you can use" not "here's why frameworks matter."
...
- **Slide deck** — clean, visual, one idea per slide.
- **Handout** — the framework on a single page, printable. The thing they take home.
- **Working tool** — if the framework can be interactive, build it.

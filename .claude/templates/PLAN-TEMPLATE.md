...
**Exit criteria:** [What must be true to consider this done]

#### Wave 1 (Parallel)
- [ ] **Task 1.1:** [Description]
  - Files/artifacts: [What's created or modified]
...
|-----------|-------|--------|------------------|
| [What we need] | [Who provides it] | [Current status] | [What happens if it's late] |
...
[Anything that doesn't fit neatly above — context, constraints, open questions to revisit.]
